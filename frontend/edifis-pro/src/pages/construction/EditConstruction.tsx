                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <DatePicker
                            ...
                            onChange={(date: Date) => setFormData(prev => ({ ...prev, start_date: date.toISOString().split('T')[0] }))}
                    ...
                    <div>
                        ...
                        <DatePicker
                            ...
                            onChange={(date: Date) => setFormData(prev => ({ ...prev, end_date: date.toISOString().split('T')[0] }))}
                            className="mt-1 h-10 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:ring-orange-500 focus:border-orange-500"
