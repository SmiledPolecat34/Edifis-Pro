...
router.post("/", protect, authorize(authorizedRoles), validateCreateCompetence, competenceController.createCompetence);
...
router.put("/:id", protect, authorize(authorizedRoles), validateUpdateCompetence, competenceController.updateCompetence);
